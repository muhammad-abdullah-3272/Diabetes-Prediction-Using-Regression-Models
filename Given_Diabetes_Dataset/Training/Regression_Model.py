...
iterations = 1000                                             # Number of times the Model will run to optimize parameters
...
## Testing the Training Dataset on Trained Model and Determining Loss
loss = Loss(X_train, Y_train, W, B)
print("Train Loss: ", loss)

## Testing the Validation Dataset on Trained Model and Determining Loss
loss = Loss(X_val, Y_val, W, B)
print("Validation Loss: ", loss)

## Testing the Test Dataset on Trained Model and Determining Loss
loss = Loss(X_test, Y_test, W, B)
