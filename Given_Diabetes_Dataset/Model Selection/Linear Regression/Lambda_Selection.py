...
for reg_param in lamdas:
    print(f"Lambda {reg_param}")
    W, B, cost_list, val_cost_list = Model(X_train, Y_train, X_val, Y_val, learning_rate = learning_rate, iterations = iterations, lamda = reg_param, verbose = False)
